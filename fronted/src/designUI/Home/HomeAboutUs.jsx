...
function HomeAboutUs(){
  ...
  dark:bg-[#2c2c2c]
    ...
    >
      <h2 className="text-3xl md:text-5xl font-bold text-primary-light dark:text-text-light">Quienes somos?
      </h2>
      <div className="grid md:grid-cols-2 gap-8 text-center items-center justify-center md:w-[80%]">
        <p className='text-center font-semibold dark:text-text-light'>
